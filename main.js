...
document.getElementById('btn-1').addEventListener('click', () => {
  window.open('https://docs.google.com/forms/d/e/1FAIpQLSfhizKPbdAlvpLLTTIdYGo14Vjk_iCoTk1Gxg0ikeTPtgyTLQ/viewform?usp=dialog', '_blank');
});

// посилання для другої кнопки
document.getElementById('btn-2').addEventListener('click', () => {
  window.open('https://docs.google.com/forms/d/e/1FAIpQLSf2owZpVdj0D_ehFpZzvHlhKbcikD43Mm1GsJ9ii12bWIIdHQ/viewform?usp=dialog', '_blank');
});
